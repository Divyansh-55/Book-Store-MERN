...
export default function Navbar() {
    return (
        <>
            <div className='max-w-screen-2xl container md:px-20  bg-slate-300 sticky top-0 '>
                <div className="navbar bg-base-100  bg-slate-300  ">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0}
                                className="menu menu-sm dropdown-content mt-3 z-[1] p-2  w-30 font-medium">
                                <li><a>Home</a></li>
                                <li><a>Course</a></li>
                                <li><a>Contact</a></li>
                                <li><a>About</a></li>
                    ...
                    <div className="flex pr-20 gap-3">
                        <div className="navbar-center hidden md:flex">
                            ...
                            <label className="input  flex items-center h-11 w-15 mr-3  mt-2">
                        ...
                        <div className="navbar-end ">
                            <a className="btn btn-outline bg-primary text-white text-xl hover:bg-slate-500 hover:text-black">Login</a>
                        </div>
                    </div>
                </div>
            </div>
